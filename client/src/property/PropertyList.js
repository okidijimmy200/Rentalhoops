  ...
  return (
    <>
      <div className={classes.root}>
        <ul
          className={classes.justifiedListBig}
          style={{
            margin: "0",
            padding: "0 10px",
            fontSize: "14px}",
        ...
        >
          <li className={classes.list} onClick={() => setSearch(!search)}>
            <button className={classes.buttonSearchIcon}>
              {/* <Modal search={search} handleCloseBtn={handleCloseBtn}/> */}
            </button>
          </li>
          <li className={classes.filter} onClick={() => setOpen(!open)}>
            Neighborhoods
          </li>
          <li className={classes.filter} onClick={() => setPrice(!price)}>
            Price
          </li>
          <li className={classes.filter} onClick={() => setBedrooms(!bedrooms)}>
            Bedrooms
          </li>
          ...
          <li className={classes.list}>
            ...
            <button className={classes.saveFilter} style={{ color: "#404040" }}>
              Clear
            </button>
          </li>{" "}
          <li className={classes.list}>
            <select className={classes.options}>
              <option value="has_photo,listing_listed_date,desc">
                Sort: Default
              </option>
                      ...
                      <Paper className={classes.paper} component="div">
                        <Card className={classes.card}>
                          <img
                            ...
                            alt="pic"
                            src={"/api/property/propertyphoto/" + property._id}
                          />
                          <Button
                            component="div"
